...
char palavra_secreta[TAMANHO_DA_PALAVRA]; // um array de char pode ser visto como um string (como ultimo caracter = \0)
char chutes[26];
int chutes_dados = 0;
...
int enforcou(){	
	return chutes_errados() >= 5; // retorn 0 se falso ou 1 se verdadeiro
}
